<%@ Page Language="C#" MasterPageFile="~/MURABAHA/Murabha.Master" AutoEventWireup="true"
    CodeBehind="Installment_Report.aspx.cs" Inherits="MuslimAID.MURABHA.Installment_Report"
    Title="Installment Details Report" %>
...
<div class="container">
    ...
    <div class="col-md-12 form-container row">
        <div class="col-md-3 form-group">
            ...
            <div class="col-md-7">
                <asp:DropDownList ID="cmbBranch" CssClass="form-control" TabIndex="0" runat="server" AutoPostBack="True" OnSelectedIndexChanged="cmbCityCode_SelectedIndexChanged"></asp:DropDownList>
            </div>
        </div>
        ...
        <div class="col-md-3 form-group">
            ...
            <input type="button" id="btnPrint" CssClass="btn btn-defult" value="Print" onclick="PrintGridData()" />
        </div>
        ...
        <div class="col-md-12 form-group">
            <asp:Panel ID="pnlMIns" CssClass="pnlChqDetail" runat="server">
                        ...
                        <td width="860px">
                            <asp:GridView ID="grvMIn" runat="server" AutoGenerateColumns="false" ItemStyle-VerticalAlign="Top" CssClass="table">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="idpais_history" ItemStyle-VerticalAlign="Top" HeaderText="Receipt No"
                                        HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Center"
                                        HeaderStyle-BackColor="#009905" HeaderStyle-BorderColor="White" HeaderStyle-ForeColor="White"
                                        ReadOnly="true" />
                                    <asp:BoundField DataField="exe_name" ItemStyle-VerticalAlign="Top" HeaderText="Follw Up Officer"
                                        HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="120px" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-BackColor="#009905" HeaderStyle-BorderColor="White" HeaderStyle-ForeColor="White"
                                        ReadOnly="true" />
                                    ...
                                    <asp:BoundField DataField="society_id" ItemStyle-VerticalAlign="Top" HeaderText="Center"
                                        HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-BackColor="#009905" HeaderStyle-BorderColor="White" HeaderStyle-ForeColor="White"
                                        ReadOnly="true" />
                                    <asp:BoundField DataField="NoCustomer" ItemStyle-VerticalAlign="Top" HeaderText="No of Customer"
                                        HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Center"
                                        HeaderStyle-BackColor="#009905" HeaderStyle-BorderColor="White" HeaderStyle-ForeColor="White"
                                        ReadOnly="true" />
                                    ...
                                    <asp:BoundField DataField="initial_name" ItemStyle-VerticalAlign="Top" HeaderText="Name"
                                        ...
                                        HeaderStyle-BackColor="#009905" HeaderStyle-BorderColor="White" HeaderStyle-ForeColor="White"
                                        ReadOnly="true" />
                                    <asp:BoundField DataField="loan_amount" ItemStyle-VerticalAlign="Top" HeaderText="Disbursed Amount"
                                        ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="80px"
                                        HeaderStyle-BackColor="#009905" HeaderStyle-BorderColor="White" HeaderStyle-ForeColor="White"
                                        ReadOnly="true" />
                                    <asp:BoundField DataField="paied_amount" ItemStyle-VerticalAlign="Top" HeaderText="Collection Amount"
                                        ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="80px"
                                        HeaderStyle-BackColor="#009905" HeaderStyle-BorderColor="White" HeaderStyle-ForeColor="White"
                                        ReadOnly="true" />
                                    <asp:BoundField DataField="date_time" ItemStyle-VerticalAlign="Top" HeaderText="Date Time"
                                        ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="150px" HeaderStyle-HorizontalAlign="Center"
                                        HeaderStyle-BackColor="#009905" HeaderStyle-BorderColor="White" HeaderStyle-ForeColor="White"
                                        ReadOnly="true" />
                                        <asp:BoundField DataField="remark" ItemStyle-VerticalAlign="Top" HeaderText="Remark"
                                        ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="150px" HeaderStyle-HorizontalAlign="Center"
                                        HeaderStyle-BackColor="#009905" HeaderStyle-BorderColor="White" HeaderStyle-ForeColor="White"
                                        ReadOnly="true" />
                                </Columns>
