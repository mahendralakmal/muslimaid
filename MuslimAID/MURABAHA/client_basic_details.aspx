    ...
    <div class="container">
        ...
        <div class="col-md-12 form-container">
            ...
            <div class="form-group">                
                ...
                <div class="col-md-7">
                    <asp:DropDownList CssClass="form-control" ID="cmbCenter" 
                        runat="server" AutoPostBack="true" TabIndex="8" 
            ...
            <div class="form-group">                
                ...
                <div class="col-md-7">
                    <asp:TextBox ID="txtSoNumber" name="txtSoNumber" CssClass="form-control" runat="server"></asp:TextBox></div>
            </div></div>          
            <div class="col-md-6">
                <div class="form-group">                
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <asp:TextBox ID="txtCC" CssClass="form-control" MaxLength="30" 
                            AutoPostBack="true" runat="server" TabIndex="10"></asp:TextBox>
                    </div>
                </div>
            </div>
        ...
        <span class="PageTitle"><h4>Information of Applicant</h4></span><br />
            ...
            <div class="form-group">                
                ...
                <div class="col-md-7"><asp:TextBox CssClass="form-control" ID="txtFullName" MaxLength="100" runat="server" TabIndex="11"></asp:TextBox></div>
            </div></div>
            <div class="col-md-12">&nbsp;</div>
            <div class="col-md-6">
            <div class="form-group">                
                <div class="col-md-5">Address as per NIC<span style="color:Red;">*</span></div>
                <div class="col-md-7"><asp:TextBox CssClass="form-control" ID="txtAddress" Height="70px" TextMode="MultiLine" MaxLength="150" runat="server" TabIndex="12"></asp:TextBox></div>
            </div></div>
            <div class="col-md-6">
            <div class="form-group">                
                <div class="col-md-5">Current Residential Address</div>
                <div class="col-md-7"><asp:TextBox CssClass="form-control" ID="txtResiAddress" Height="70px" TextMode="MultiLine" MaxLength="150" runat="server" TabIndex="13"></asp:TextBox></div>
            </div></div>
            <div class="col-md-6">
            <div class="form-group">                
            ...
            <div class="form-group">                
                ...
                <div class="col-md-7"><asp:TextBox CssClass="form-control" ID="txtGSWard" MaxLength="45" runat="server" TabIndex="15"></asp:TextBox></div>
            </div></div>
        ...
        <div class="col-md-12 form-container">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="col-md-5">Gender</div>
                    <div class="col-md-7">
                        <asp:RadioButton ID="rdoSoMale" Text="Male" runat="server" TabIndex="7" Checked="true" GroupName="rdoSoGender" />
                        <asp:RadioButton ID="rdoSoFeMale" TabIndex="25" Text="Female" runat="server" GroupName="rdoSoGender"/>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <asp:DropDownList CssClass="form-control" TabIndex="30" ID="cmbRelation" runat="server">
        ...
        <div class="col-md-12 form-container">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <asp:DropDownList ID="cmbBNature" CssClass="form-control" runat="server" TabIndex="28">
                        </asp:DropDownList>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <asp:TextBox ID="txtBusiness" runat="server" TabIndex="29" CssClass="form-control"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-7">                    
                        <asp:DropDownList CssClass="form-control" TabIndex="30" ID="cmbKeyPerson" runat="server">
                            <asp:ListItem></asp:ListItem>
                            <asp:ListItem>Husband</asp:ListItem>
                            <asp:ListItem>Wife</asp:ListItem>
                            <asp:ListItem>Son</asp:ListItem>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-7"><asp:TextBox ID="txtNoOfPpl" 
                            CssClass="numbersOnly form-control" runat="server" TabIndex="31"></asp:TextBox></div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <div class="col-md-5">Business Address<span style="color:Red;">*</span></div>
                    <div class="col-md-7"><asp:TextBox ID="txtBisAddress" CssClass="form-control" Height="70px" TextMode="MultiLine" MaxLength="150" runat="server" TabIndex="32"></asp:TextBox></div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <asp:DropDownList CssClass="form-control" ID="cmbPeriod" runat="server" TabIndex="33">
                            <asp:ListItem></asp:ListItem>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-7"><asp:TextBox ID="txtBContact" CssClass="form-control" runat="server" TabIndex="34" AutoPostBack="false"></asp:TextBox></div>
                </div>
            </div>
        </div>
        <div class="col-md-12 form-container">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <asp:TextBox ID="txtResonToApply" CssClass="form-control" Height="70px" TextMode="MultiLine" MaxLength="150" runat="server" TabIndex="35"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-7"><asp:TextBox ID="txtLDLAmount" CssClass="numbersOnly form-control loanAmount" MaxLength="12" runat="server" TabIndex="36"  onkeydown="return isNumeric(event.keyCode);" onKeypress="javascript:return check(event);"></asp:TextBox></div>
                </div>
            </div>
            <div class="col-md-12"></div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <asp:DropDownList ID="cmbTmePeriod" CssClass="form-control period" runat="server" TabIndex="37">
                        </asp:DropDownList>
                    </div>
                </div>
            </div>
                ...
                <div class="form-group">
                    <div class="col-md-12">Any unsettled advances/ facilities available :<span style="color:Red;">* </span>
                        <asp:RadioButton GroupName="rdoUnsetlled" CssClass="rdoUnsetlled rdoYes1" 
                            TabIndex="38" ID="rdoYes" runat="server" AutoPostBack="True" 
                            oncheckedchanged="rdoYes_CheckedChanged" /> Yes &nbsp;&nbsp;
                        <asp:RadioButton GroupName="rdoUnsetlled" CssClass="rdoUnsetlled rdoNo1" 
                            TabIndex="39" ID="rdoNo" Checked="true" runat="server" AutoPostBack="True" 
            ...
            <div class="col-md-12">
                <div class="table-back form-group table-responsive">
                    <table class="table" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td>1</td>
                            <td><asp:TextBox TabIndex="40" CssClass="form-control" ID="txtNameOrg1" runat="server"></asp:TextBox></td>
                            <td><asp:TextBox TabIndex="41" CssClass="form-control" ID="txtPurpos1" runat="server"></asp:TextBox></td>
                            <td><asp:TextBox TabIndex="42" CssClass="numbersOnly form-control" ID="txtFAmount1" runat="server"></asp:TextBox></td>
                            <td><asp:TextBox TabIndex="43" CssClass="form-control" ID="txtOutstandBal1" runat="server"></asp:TextBox></td>
                            <td><asp:TextBox TabIndex="44" CssClass="form-control" ID="txtMonthInstal1" runat="server"></asp:TextBox></td>
                            <td><asp:TextBox TabIndex="45" CssClass="form-control" ID="txtRemainInstal1" runat="server"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td><asp:TextBox TabIndex="46" CssClass="form-control" ID="txtNameOrg2" runat="server"></asp:TextBox></td>
                            <td><asp:TextBox TabIndex="47" CssClass="form-control" ID="txtPurpos2" runat="server"></asp:TextBox></td>
                            <td><asp:TextBox TabIndex="48" CssClass="numbersOnly form-control" ID="txtFAmount2" runat="server"></asp:TextBox></td>
                            <td><asp:TextBox TabIndex="49" CssClass="form-control" ID="txtOutstandBal2" runat="server"></asp:TextBox></td>
                            <td><asp:TextBox TabIndex="50" CssClass="form-control" ID="txtMonthInstal2" runat="server"></asp:TextBox></td>
                            <td><asp:TextBox TabIndex="51" CssClass="form-control" ID="txtRemainInstal2" runat="server"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td>3</td>
                            <td><asp:TextBox TabIndex="52" CssClass="form-control" ID="txtNameOrg3" runat="server"></asp:TextBox></td>
                            <td><asp:TextBox TabIndex="53" CssClass="form-control" ID="txtPurpos3" runat="server"></asp:TextBox></td>
                            <td><asp:TextBox TabIndex="54" CssClass="numbersOnly form-control" ID="txtFAmount3" runat="server"></asp:TextBox></td>
                            <td><asp:TextBox TabIndex="55" CssClass="form-control" ID="txtOutstandBal3" runat="server"></asp:TextBox></td>
                            <td><asp:TextBox TabIndex="56" CssClass="form-control" ID="txtMonthInstal3" runat="server"></asp:TextBox></td>
                            <td><asp:TextBox TabIndex="57" CssClass="form-control" ID="txtRemainInstal3" runat="server"></asp:TextBox></td>
                        </tr>
                    </table>
                </div>
            </div>
        ...
        <div class="col-md-12 form-container">
            ...
            <div class="col-md-12">
                ...
                <%--<div class="col-md-12" title="Yes">
                    ...
                    <table class="" width="100%" cellpadding="0" cellspacing="0" TabIndex="58">
                        <tr>
                            <th></th>
                        ...
                        <tr>
                            <td>1</td>
                            <td><asp:TextBox TabIndex="59" CssClass="form-control" ID="txtName1" runat="server"></asp:TextBox></td>
                            <td>
                        <asp:DropDownList CssClass="form-control" TabIndex="30" ID="cmbRelation1" runat="server">
                            <asp:ListItem></asp:ListItem>
                            ...
                            <td>
                                <div class='input-group date' id='DobCDB1' name='DobCDB1'>
                                    <asp:TextBox TabIndex="62" CssClass="form-control numbersOnly" ID="txtDOB1" MaxLength="10" runat="server"></asp:TextBox>
                                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                            </td>
                            <td><asp:TextBox TabIndex="63" CssClass="form-control" ID="txtOcc1" runat="server"></asp:TextBox></td>
                            <td><asp:TextBox TabIndex="64" CssClass="form-control numbersOnly" ID="txtInCome1" runat="server"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td><asp:TextBox TabIndex="65" CssClass="form-control" ID="txtName2" runat="server"></asp:TextBox></td>
                            <td>
                        <asp:DropDownList CssClass="form-control" TabIndex="30" ID="cmbRelation2" runat="server">
                            <asp:ListItem></asp:ListItem>
                            <asp:ListItem>Client</asp:ListItem>                            <asp:ListItem>Husband</asp:ListItem>
                            <asp:ListItem>Wife</asp:ListItem>
                            <asp:ListItem>Son</asp:ListItem>
                            ...
                            <td>
                                <div class='input-group date' id='DobCDB2' name='DobCDB2'>
                                    <asp:TextBox TabIndex="68" CssClass="form-control numbersOnly" ID="txtDOB2" MaxLength="10" runat="server"></asp:TextBox>
                                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                            </td>
                            <td><asp:TextBox TabIndex="69" CssClass="form-control" ID="txtOcc2" runat="server"></asp:TextBox></td>
                            <td><asp:TextBox TabIndex="70" CssClass="form-control numbersOnly" ID="txtInCome2" runat="server"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td>3</td>
                            <td><asp:TextBox TabIndex="71" CssClass="form-control" ID="txtName3" runat="server"></asp:TextBox></td>
                            <td>
                        <asp:DropDownList CssClass="form-control" TabIndex="30" ID="cmbRelation3" runat="server">
                            <asp:ListItem></asp:ListItem>
                            <asp:ListItem>Client</asp:ListItem>                            <asp:ListItem>Husband</asp:ListItem>
                            <asp:ListItem>Wife</asp:ListItem>
                            <asp:ListItem>Son</asp:ListItem>
                            ...
                            <td>
                                <div class='input-group date' id='DobCDB3' name='DobCDB3'>
                                    <asp:TextBox TabIndex="74" CssClass="form-control numbersOnly" ID="txtDOB3" MaxLength="10" runat="server"></asp:TextBox>
                                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                            </td>
                            <td><asp:TextBox TabIndex="75" CssClass="form-control" ID="txtOcc3" runat="server"></asp:TextBox></td>
                            <td><asp:TextBox TabIndex="76" CssClass="form-control numbersOnly" ID="txtInCome3" runat="server"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td>4</td>
                            <td><asp:TextBox TabIndex="77" CssClass="form-control" ID="txtName4" runat="server"></asp:TextBox></td>
                            <td>
                        <asp:DropDownList CssClass="form-control" TabIndex="30" ID="cmbRelation4" runat="server">
                            <asp:ListItem></asp:ListItem>
                            <asp:ListItem>Client</asp:ListItem>                            <asp:ListItem>Husband</asp:ListItem>
                            <asp:ListItem>Wife</asp:ListItem>
                            <asp:ListItem>Son</asp:ListItem>
                            ...
                            <td>
                                <div class='input-group date' id='DobCDB4' name='DobCDB4'>
                                    <asp:TextBox TabIndex="80" CssClass="form-control numbersOnly" MaxLength="10" ID="txtDOB4" runat="server"></asp:TextBox>
                                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                            </td>
                            <td><asp:TextBox TabIndex="81" CssClass="form-control" ID="txtOcc4" runat="server"></asp:TextBox></td>
                            <td><asp:TextBox TabIndex="82" CssClass="form-control numbersOnly" ID="txtInCome4" runat="server"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td>5</td>
                            <td><asp:TextBox TabIndex="83" CssClass="form-control" ID="txtName5" runat="server"></asp:TextBox></td>
                            <td>
                        <asp:DropDownList CssClass="form-control" TabIndex="30" ID="cmbRelation5" runat="server">
                            <asp:ListItem></asp:ListItem>
                            <asp:ListItem>Client</asp:ListItem>                            <asp:ListItem>Husband</asp:ListItem>
                            <asp:ListItem>Wife</asp:ListItem>
                            <asp:ListItem>Son</asp:ListItem>
                            ...
                            <td>
                                <div class='input-group date' id='DobCDB5' name='DobCDB5'>
                                    <asp:TextBox TabIndex="86" CssClass="form-control numbersOnly" MaxLength="10" ID="txtDOB5" runat="server"></asp:TextBox>
                                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                            </td>
                            <td><asp:TextBox TabIndex="87" CssClass="form-control" ID="txtOcc5" runat="server"></asp:TextBox></td>
                            <td><asp:TextBox TabIndex="88" CssClass="form-control numbersOnly" ID="txtInCome5" runat="server"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td>6</td>
                            <td><asp:TextBox TabIndex="89" CssClass="form-control" ID="txtName6" runat="server"></asp:TextBox></td>
                            <td>
                        <asp:DropDownList CssClass="form-control" TabIndex="30" ID="cmbRelation6" runat="server">
                            <asp:ListItem></asp:ListItem>
                            <asp:ListItem>Client</asp:ListItem>                            <asp:ListItem>Husband</asp:ListItem>
                            <asp:ListItem>Wife</asp:ListItem>
                            <asp:ListItem>Son</asp:ListItem>
                            ...
                            <td>
                                <div class='input-group date' id='DobCDB6' name='DobCDB6'>
                                    <asp:TextBox TabIndex="92" CssClass="form-control numbersOnly" MaxLength="10" ID="txtDOB6" runat="server"></asp:TextBox>
                                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                            </td>
                            <td><asp:TextBox TabIndex="93" CssClass="form-control" ID="txtOcc6" runat="server"></asp:TextBox></td>
                            <td><asp:TextBox TabIndex="94" CssClass="form-control numbersOnly" ID="txtInCome6" runat="server"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td>7</td>
                            <td><asp:TextBox TabIndex="95" CssClass="form-control" ID="txtName7" runat="server"></asp:TextBox></td>
                            <td>
                        <asp:DropDownList CssClass="form-control" TabIndex="30" ID="cmbRelation7" runat="server">
                            <asp:ListItem></asp:ListItem>
                            <asp:ListItem>Client</asp:ListItem>                            <asp:ListItem>Husband</asp:ListItem>
                            <asp:ListItem>Wife</asp:ListItem>
                            <asp:ListItem>Son</asp:ListItem>
                            ...
                            <td>
                                <div class='input-group date' id='DobCDB7' name='DobCDB7'>
                                    <asp:TextBox TabIndex="98" CssClass="form-control numbersOnly" MaxLength="10" ID="txtDOB7" runat="server"></asp:TextBox>
                                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                            </td>
                            <td><asp:TextBox TabIndex="99" CssClass="form-control" ID="txtOcc7" runat="server"></asp:TextBox></td>
                            <td><asp:TextBox TabIndex="100" CssClass="form-control numbersOnly" ID="txtInCome7" runat="server"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td>8</td>
                            <td><asp:TextBox TabIndex="101" CssClass="form-control" ID="txtName8" runat="server"></asp:TextBox></td>
                            <td>
                        <asp:DropDownList CssClass="form-control" TabIndex="30" ID="cmbRelation8" runat="server">
                            <asp:ListItem></asp:ListItem>
                            <asp:ListItem>Client</asp:ListItem>                            <asp:ListItem>Husband</asp:ListItem>
                            <asp:ListItem>Wife</asp:ListItem>
                            <asp:ListItem>Son</asp:ListItem>
                            ...
                            <td>
                                <div class='input-group date' id='DobCDB8' name='DobCDB8'>
                                    <asp:TextBox TabIndex="104" CssClass="form-control numbersOnly" MaxLength="10" ID="txtDOB8" runat="server"></asp:TextBox>
                                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                            </td>
                            <td><asp:TextBox TabIndex="105" CssClass="form-control" ID="txtOcc8" runat="server"></asp:TextBox></td>
                            <td><asp:TextBox TabIndex="106" CssClass="form-control numbersOnly" ID="txtInCome8" runat="server"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td>9</td>
                            <td><asp:TextBox TabIndex="107" CssClass="form-control" ID="txtName9" runat="server"></asp:TextBox></td>
                            <td>
                        <asp:DropDownList CssClass="form-control" TabIndex="30" ID="cmbRelation9" runat="server">
                            <asp:ListItem></asp:ListItem>
                            <asp:ListItem>Client</asp:ListItem>                            <asp:ListItem>Husband</asp:ListItem>
                            <asp:ListItem>Wife</asp:ListItem>
                            <asp:ListItem>Son</asp:ListItem>
                            ...
                            <td>
                                <div class='input-group date' id='DobCDB9' name='DobCDB9'>
                                    <asp:TextBox TabIndex="110" CssClass="form-control numbersOnly" MaxLength="10" ID="txtDOB9" runat="server"></asp:TextBox>
                                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                            </td>
                            <td><asp:TextBox TabIndex="111" CssClass="form-control" ID="txtOcc9" runat="server"></asp:TextBox></td>
                            <td><asp:TextBox TabIndex="112" CssClass="form-control numbersOnly" ID="txtInCome9" runat="server"></asp:TextBox></td>
                        </tr>
                    </table>
                </div>
            </div>
        ...
        <div class="col-md-12 form-container">
            <div class="col-md-12">
                <asp:Button ID="btnSubmit" CssClass="btn btn-primary" Enabled="false" 
                    runat="server" Text="Submit" TabIndex="113" onclick="btnSubmit_Click"/>&nbsp;
                <asp:Button ID="btnUpdate" CssClass="btn btn-primary" Enabled="false" 
                    runat="server" Text="Update" 
                        TabIndex="114" onclick="btnUpdate_Click" />
