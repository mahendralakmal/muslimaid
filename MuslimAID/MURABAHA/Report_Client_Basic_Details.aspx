...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <div class="PageTitle">
            <h4>CS - Client Basic Details Report</h4>
        </div>
        <div class="col-md-12 form-container row">
            ...
            <div class="col-md-3 form-group">
                ...
                <input type="button" id="btnPrint" CssClass="btn btn-default" value="Print" onclick="PrintGridData()" />
            </div>
            <div class="col-md-3 form-group">
                    ...
                    <asp:Panel ID="pnlClientDetail" runat="server">
                        <asp:GridView ID="grvCliDeta" runat="server" AutoGenerateColumns="false" ItemStyle-VerticalAlign="Top" CssClass="table">
                            <Columns>
                                ...
                                <asp:BoundField DataField="full_name" ItemStyle-VerticalAlign="Top" HeaderText="Name" HeaderStyle-Width="120px" ItemStyle-HorizontalAlign="Left" HeaderStyle-BackColor="#009905" HeaderStyle-BorderColor="White" HeaderStyle-ForeColor="White" ReadOnly="true" />
                                <asp:BoundField DataField="p_address" ItemStyle-VerticalAlign="Top" HeaderText="Address" HeaderStyle-Width="260px" HeaderStyle-BackColor="#009905" HeaderStyle-BorderColor="White" HeaderStyle-ForeColor="White" ReadOnly="true" />
                                <asp:BoundField DataField="mobile_no" ItemStyle-VerticalAlign="Top" HeaderText="Contact No" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center" HeaderStyle-BackColor="#009905" HeaderStyle-BorderColor="White" HeaderStyle-ForeColor="White" ReadOnly="true" />
