    ...
    <div class="col-md-12 form-container">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-md-7"><asp:TextBox ID="txtRenPayEx" CssClass="numbersOnly form-control txtRenPay" onchange="calcMExpenses()" runat="server" TabIndex="11"></asp:TextBox></div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <div class="col-md-5">Other facility/advance installments</div>
                <div class="col-md-7"><asp:TextBox ID="txtOFAIEx" CssClass="numbersOnly form-control txtOFAI" onchange="calcMExpenses()" runat="server" TabIndex="12"></asp:TextBox></div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <div class="col-md-5">Travel & Transport</div>
                <div class="col-md-7"><asp:TextBox ID="txtTTransEx" CssClass="numbersOnly form-control txtTTrans" onchange="calcMExpenses()" runat="server" TabIndex="13"></asp:TextBox></div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <div class="col-md-5">Clothes</div>
                <div class="col-md-7"><asp:TextBox ID="txtClothsEx" CssClass="numbersOnly form-control txtCloths" onchange="calcMExpenses()" runat="server" TabIndex="14"></asp:TextBox></div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <div class="col-md-5">Others</div>
                <div class="col-md-7"><asp:TextBox ID="txtOthersEx" CssClass="numbersOnly form-control txtOthers" onchange="calcMExpenses()" runat="server" TabIndex="15"></asp:TextBox></div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:TextBox ID="txtFExpense" 
                        CssClass="form-control txtFExpense" runat="server" TabIndex="16"></asp:TextBox></div>
            </div>
        </div>
        <div class="col-md-12"></div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:TextBox ID="txtNetAnualFIn" 
                        ...
                        runat="server" TabIndex="17"></asp:TextBox></div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <div class="col-md-5"><strong>Amount that can be used for other purposes (monthly)</strong></div>
                <div class="col-md-7"><asp:TextBox ID="txtAmountOPEx" Enabled="true" CssClass="numbersOnly txtAmountOPEx form-control" runat="server" TabIndex="18"></asp:TextBox></div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <div class="col-md-5"><strong>Maximum amount payable for the facility (monthly/ weekly)</strong></div>
                <div class="col-md-7"><asp:TextBox ID="txtAmountFEx" Enabled="true" CssClass="numbersOnly txtAmountFEx form-control" runat="server" TabIndex="19"></asp:TextBox></div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <div class="col-md-5"><strong>Facility Repayment period (months/weeks)</strong></div>
                <div class="col-md-7"><asp:TextBox ID="txtFRPriod" Enabled="true" onchange="calcMaxAmountCanBeDisbursed()" CssClass="numbersOnly txtFRPriod form-control" runat="server" TabIndex="20"></asp:TextBox></div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <div class="col-md-5"><strong>Maximum amount can be disbursed</strong></div>
                <div class="col-md-7"><asp:TextBox ID="txtMAD" Enabled="true" CssClass="numbersOnly txtMAD form-control" runat="server" TabIndex="21"></asp:TextBox></div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <div class="col-md-5"><strong>Maximum disbursable amount according to the institutional policy</strong></div>
                <div class="col-md-7"><asp:TextBox ID="txtMDAAIP" Enabled="true" CssClass="numbersOnly txtMDAAIP form-control" runat="server" TabIndex="22"></asp:TextBox></div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <div class="col-md-5"><strong>Requested amount as per the facility application</strong></div>
                <div class="col-md-7"><asp:TextBox ID="txtRAPSA" Enabled="true" CssClass="numbersOnly txtRAPSA form-control" runat="server" TabIndex="23"></asp:TextBox></div>
            </div>
        </div>
