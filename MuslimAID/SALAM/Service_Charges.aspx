<%@ Page Language="C#" MasterPageFile="~/SALAM/Salam.Master" AutoEventWireup="true" CodeBehind="Service_Charges.aspx.cs" Inherits="MuslimAID.SALAM.Service_Charges" Title="Ventura Crystal Investments Ltd ::: Documentation & Insurance Charges" %>
                ...
                <div class="form-group">
                    <asp:GridView ID="grvPayment" runat="server" AutoGenerateColumns="false">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="service_charges" ItemStyle-VerticalAlign="Top" HeaderText="Service Charges" ItemStyle-HorizontalAlign="Right" HeaderStyle-BackColor="#006699" HeaderStyle-BorderColor="White" HeaderStyle-ForeColor="White" ReadOnly="true" />
                                            <asp:BoundField DataField="registration_fee" HeaderText="Registration Fee" ItemStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Right" HeaderStyle-BackColor="#006699" HeaderStyle-BorderColor="White" HeaderStyle-ForeColor="White" ReadOnly="true" />
                                            <asp:BoundField DataField="walfare_fee" HeaderText="Walfare Fee" ItemStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Right" HeaderStyle-BackColor="#006699" HeaderStyle-BorderColor="White" HeaderStyle-ForeColor="White" ReadOnly="true" />
                                            <asp:BoundField DataField="other_charges" HeaderText="Other Charges" ItemStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Right" HeaderStyle-BackColor="#006699" HeaderStyle-BorderColor="White" HeaderStyle-ForeColor="White" ReadOnly="true" />
