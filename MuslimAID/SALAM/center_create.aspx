<%@ Page Language="C#" MasterPageFile="~/SALAM/Salam.Master" AutoEventWireup="true" CodeBehind="center_create.aspx.cs" Inherits="MuslimAID.SALAM.center_create" Title="Untitled Page" %>
...
<div class="container">
    ...
    <div class="col-md-6 form-container">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7"><asp:TextBox ID="txtContactNo" TabIndex="5" MaxLength="10" CssClass="form-control numbersOnly" runat="server" onKeypress="javascript:return check(event);"></asp:TextBox></div>
            </div>
            <div class="form-group">
