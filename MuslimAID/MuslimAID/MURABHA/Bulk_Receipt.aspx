<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bulk_Receipt.aspx.cs" Inherits="MuslimAID.MURABHA.Bulk_Receipt" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Ventura Crystal Investments Ltd ::: CS Bulk Receipt</title>
    ...
    <div align="center">
        <asp:Panel ID="pnlSearch" runat="server" Visible="true">
         ...
         <asp:Panel ID="pnlFull" runat="server" Visible="false">
             <table cellpadding="0" cellspacing="0" border="0" align="left">
                <tr>
                    <td style="height:20px; font-family:Calibri; font-size:10pt; color:Gray;">
                        <asp:LinkButton ID="lnkFirst" runat="server" Font-Bold="True" Font-Size="10pt" onclick="lnkFirst_Click">First</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="lnkPrevious" runat="server" Font-Bold="True" Font-Size="10pt" onclick="lnkPrevious_Click">&lt;&lt;Previous</asp:LinkButton>&nbsp;&nbsp;
                        <asp:Label ID="lblPages" runat="server" Font-Bold="True" Font-Size="10pt" ForeColor="Gray"></asp:Label>&nbsp;&nbsp;
                        <asp:LinkButton ID="lnkNext" runat="server" Font-Bold="True" Font-Size="10pt" onclick="lnkNext_Click">Next &gt;&gt;</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="lnkLast" runat="server" Font-Bold="True" Font-Size="10pt" onclick="lnkLast_Click">Last</asp:LinkButton>
                    </td>
                </tr>
                <tr>
                    <td>
                            ...
                            <ItemTemplate>
                                <div id="invoice" class="print">
                                    <table cellpadding="0" cellspacing="0" border="0" width="400px" align="left" style="font-size:9pt; font-family:Calibri; text-align:left;">
                                        ...
                                        <tr>
                                            <td colspan="7">
                                                Received a sum of Rs.<%#Eval("paied_amount", "{0:N2}")%> <%--<asp:Label ID="lblAmou" runat="server"></asp:Label>--%> In Cash.<br />
                                                <%--<asp:Label ID="lblAmouText" runat="server"></asp:Label>--%>
                                                <%#Eval("amount_text")%> Rupees Only.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="7" height="10px"></td>
                                        ...
                                        <tr>
                                            <td colspan="7">
                                               <table cellpadding="0" cellspacing="0" border="0" width="400px" align="left" style="font-family:Calibri; font-size:9pt;">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <%#Eval("curr_arres", "{0:N2}")%><%--<asp:Label ID="lblArrears" runat="server"></asp:Label>--%>
                                                        </td>
                                                        <td></td>
                                                        <td>
                                                            <%#Eval("balance", "{0:N2}")%><%--<asp:Label ID="lblFullBal" runat="server"></asp:Label>--%>
                                                        </td>
                                                        <td></td>
                                                        <td>
                                                            <%#Eval("due_date")%><%--<asp:Label ID="lblDueDa" runat="server"></asp:Label>--%>
                                                        </td>
                                                    </tr>
                                               </table>
                                            </td>
                ...
                <tr>
                    <td>
                        ...
                        <asp:HiddenField ID="hiCurrentPage" runat="server" Value="1" />
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:LinkButton ID="lnkFirstB" runat="server" Font-Bold="True" Font-Size="10pt" onclick="lnkFirst_Click">First</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="lnkPreviousB" runat="server" Font-Bold="True" Font-Size="10pt" onclick="lnkPrevious_Click">&lt;&lt;Previous</asp:LinkButton>&nbsp;&nbsp;
                        <asp:Label ID="lblPagesB" runat="server" Font-Bold="True" Font-Size="10pt"></asp:Label>&nbsp;&nbsp;
                        <asp:LinkButton ID="lnkNextB" runat="server" Font-Bold="True" Font-Size="10pt" onclick="lnkNext_Click">Next &gt;&gt;</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="lnkLastB" runat="server" Font-Bold="True" Font-Size="10pt" onclick="lnkLast_Click">Last</asp:LinkButton>
                    </td>
                </tr>
            </table>
        </asp:Panel>
