<%@ Page Language="C#" MasterPageFile="~/MURABHA/Murabha.Master" AutoEventWireup="true" CodeBehind="MasterSheet.aspx.cs" Inherits="MuslimAID.MURABHA.MasterSheet" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div align="center">
        <table cellpadding="0" cellspacing="0" border="0" width="860px" align="left">
            <tr>
                <td colspan="9" width="860px" class="PageTitle">Master Sheet</td>
            </tr>
            <tr>
                                ...
                                <td width="860px">
                                    <asp:GridView ID="gdvMasterSheet" runat="server" AutoGenerateColumns="false" CssClass="MasterSheet" ItemStyle-VerticalAlign="Top">
                                        <Columns>      
                                            ...
                                            <asp:BoundField DataField="Rental" ItemStyle-VerticalAlign="Top" HeaderText="Rental" ReadOnly="true" />
                                            <asp:BoundField DataField="DueDate" ItemStyle-VerticalAlign="Top" HeaderText="Due Date" ReadOnly="true" />
                                            <asp:BoundField DataField="NoOfDaysinArrears" ItemStyle-VerticalAlign="Top" HeaderText="No Of Days in Arrears" ReadOnly="true" />
                                            <asp:BoundField DataField="FutureCapitalAmount" ItemStyle-VerticalAlign="Top" HeaderText="Future Capital Amount" ReadOnly="true" />
                                            <asp:BoundField DataField="FutureInterestAmount" ItemStyle-VerticalAlign="Top" HeaderText="Future Interest Amount" ReadOnly="true" />
                                            <asp:BoundField DataField="NoOfRentalMatured" ItemStyle-VerticalAlign="Top" HeaderText="No Of Rental Matured" ReadOnly="true" />
                                            <asp:BoundField DataField="NoOfRentalCollected" ItemStyle-VerticalAlign="Top" HeaderText="No Of Rental Collected" ReadOnly="true" />
                                            <asp:BoundField DataField="Period" ItemStyle-VerticalAlign="Top" HeaderText="Period" ReadOnly="true" />
                                            <asp:BoundField DataField="NoOfRentalInArrears" ItemStyle-VerticalAlign="Top" HeaderText="No Of Rental In Arrears" ReadOnly="true" />
                                            <asp:BoundField DataField="RentalAmountInArreas" ItemStyle-VerticalAlign="Top" HeaderText="Rental Amount In Arreas" ReadOnly="true" />
                                            <asp:BoundField DataField="RecoverableBalance" ItemStyle-VerticalAlign="Top" HeaderText="Recoverable Balance" ReadOnly="true" />
                                            <asp:BoundField DataField="UnearnCarryingCharges" ItemStyle-VerticalAlign="Top" HeaderText="Unearn Carrying Charges" ReadOnly="true" />
                                            <asp:BoundField DataField="CapitalArrearsAmount" ItemStyle-VerticalAlign="Top" HeaderText="Capital Arrears Amount" ReadOnly="true" />
                                            <asp:BoundField DataField="InterestArrearsAmount" ItemStyle-VerticalAlign="Top" HeaderText="Interest Arrears Amount" ReadOnly="true" />
                                            <asp:BoundField DataField="InterestInSuspenseAmount" ItemStyle-VerticalAlign="Top" HeaderText="Interest In Suspense Amount"  ReadOnly="true" />
                                            <asp:BoundField DataField="ODArreasAmount" ItemStyle-VerticalAlign="Top" HeaderText="OD Arreas Amount" ReadOnly="true" />
                                            <asp:BoundField DataField="OtherChargesArrearsAmount" ItemStyle-VerticalAlign="Top" HeaderText="Other Charges Arrears Amount" ReadOnly="true" />
                                            <asp:BoundField DataField="OtherChargesCollectedAmount" ItemStyle-VerticalAlign="Top" HeaderText="Other Charges Collected Amount" ReadOnly="true" />
                                            <asp:BoundField DataField="TotalOverpaymentAmount" ItemStyle-VerticalAlign="Top" HeaderText="Total Overpayment Amount" ReadOnly="true" />
                                        </Columns>
                                    </asp:GridView>
                                </td>
                            </tr>
