...
<head runat="server">
    <title>Ventura Crystal Investments Ltd ::: Cheque Approval</title>
    ...
    <div align="center">
        <table cellpadding="0" cellspacing="0" border="0" width="500px" align="left">
            ...
            <tr>
                ...
                <td valign="top">:</td>
                <td>
                    <asp:TextBox ID="txtCNumber" MaxLength="20" TabIndex="0" Width="120px" runat="server" onkeydown="return isNumeric(event.keyCode);"
