<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Chequ_Print.aspx.cs" Inherits="MuslimAID.MURABHA.Chequ_Print" %>
...
<body style="font-family:Calibri; font-size:10pt;">
    ...
    <div align="center" id="prt">
        <table cellpadding="0" cellspacing="0" border="0px" width="672.755906px">
            <tr>
                <td colspan="10" width="672.755906px" height="3px"></td>
            </tr>
            <tr>
                <td width="442.204724px" height="22.677165px"></td>
                ...
                <td width="22.677165px" height="22.677165px"></td>
                <td width="22.677165px" height="22.677165px"></td>
                <td width="22.677165px" height="22.677165px" align="center">
                    <asp:Label ID="lblYear1" runat="server"></asp:Label>
                </td>
                <td width="22.677165px" height="22.677165px" align="right">
                    <asp:Label ID="lblYear2" runat="server"></asp:Label>
                </td>
                <td width="37.795276px" height="22.677165px"></td>
            </tr>
            <tr>
                <td colspan="10" valign="top">
                    <table cellpadding="0" cellspacing="0" border="0" width="672.755906px">
                        <tr>
                            <td colspan="3" height="32.23622px"></td>
                        </tr>
                        <tr>
                            <td width="49.133858px" height="45.354331px"></td>
                            <td width="585.826772px" align="left" valign="top">
                                ***<asp:Label ID="lblName" runat="server"></asp:Label>***
                            </td>
                            <td width="37.795276px"></td>
                        </tr>
                    </table>
                </td>
            </tr>
                        ...
                        <tr>
                            <td width="411.968504px" valign="top">
                                <table cellpadding="0" cellspacing="0" border="0" width="411.968504px">
                                    <tr>
                                        <td width="68.031496px" height="64.251969px"></td>
                                        <td width="343.937008" valign="top" align="left" height="64.251969px">
                                            ***<asp:Label ID="lblAmountText" runat="server"></asp:Label> ONLY***
                                        </td>  
                                    </tr>
                                    <%--<tr>
