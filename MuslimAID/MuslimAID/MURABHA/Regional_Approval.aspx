<%@ Page Language="C#" MasterPageFile="~/MURABHA/Murabha.Master" AutoEventWireup="true" CodeBehind="Regional_Approval.aspx.cs" Inherits="MuslimAID.MURABHA.Regional_Approval" Title="Ventura Crystal Investments Ltd ::: Regional Loan Approval" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div align="center">
        <table cellpadding="0" cellspacing="0" border="0" width="860px" align="left">
            <tr>
                <td width="860px" class="PageTitle">MF - Regional Loan Approval Details</td>
            </tr>
            <tr>
                <td height="10px"></td>
            </tr>
